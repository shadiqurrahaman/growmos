    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <form onSubmit={handleSubmit} className="max-w-4xl mx-auto px-6 py-8 space-y-6">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-5">
          <h2 className="font-semibold text-gray-900 text-sm uppercase tracking-wide text-gray-500">Post Details</h2>
          ...
          <div>
            ...
            <input
              type="text" required
              value={form.title}
              onChange={e => { const t = e.target.value; setForm(p => ({ ...p, title: t, slug: generateSlug(t) })); }}
          ...
          <div>
            ...
            <textarea
              ...
              placeholder="Short summary shown in blog cards (130 chars max)"
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
          <h2 className="font-semibold text-gray-900 text-sm uppercase tracking-wide text-gray-500">Featured Image</h2>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
          <h2 className="font-semibold text-gray-900 text-sm uppercase tracking-wide text-gray-500">Content *</h2>
          <p className="text-xs text-gray-400">HTML is supported. Use &lt;p&gt;, &lt;h2&gt;, &lt;ul&gt;, &lt;strong&gt;, etc.</p>
          <textarea
            required
            rows={16}
            value={form.content}
            ...
            className="w-full px-4 py-3 border border-gray-200 rounded-xl text-gray-900 focus:outline-none focus:ring-2 focus:ring-purple-500 font-mono text-sm resize-y"
          />
        </div>
        ...
        <div className="bg-white rounded-2xl border border-gray-200 p-6">
          <div className="flex items-center justify-between">
            <div>
              <h2 className="font-semibold text-gray-900 text-sm uppercase tracking-wide text-gray-500 mb-0.5">Publish</h2>
              <p className="text-xs text-gray-400">Make this post visible on the site</p>
            </div>
            <button
              type="button"
              onClick={() => setForm(p => ({ ...p, published: !p.published }))}
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${form.published ? "bg-purple-600" : "bg-gray-200"}`}
            >
        ...
        <div className="flex items-center gap-3 justify-end pb-8">
          <Link href="/admin/dashboard" className="px-5 py-2.5 text-sm font-semibold text-gray-600 hover:text-gray-900 bg-white border border-gray-200 rounded-xl transition-colors">
            Cancel
          </Link>
          <button
            type="submit"
          ...
          >
            {saving ? <><i className="fa-solid fa-spinner fa-spin"></i> Saving…</> : <><i className="fa-solid fa-check"></i> Save Post</>}
          </button>
        </div>
      </form>
    </div>
